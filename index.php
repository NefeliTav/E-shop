    ...
    <div>
        ...
        <div class="container" id="products">
            ...
            <div class="grid-container">
                <div class="productButton"><a class="productLink" href="#"><img src="./images/catalog.png" alt="catalog"
                ...
                <div class="productButton"><a class="productLink" href="#"><img src="./images/photo3.png"
                ...
                <div class="categoryText">
                    <h3 style="padding:20px;" id="prod" class="categoryTitle">Hobbyist</h3>
            ...
            <div class="container" name=contact id="contact" style="background-color:#f1f1f1">
                ...
                <div class="row">
                    ...
                    <div class="column-66">
                        ...
                        <p style="font-size:22px">Opening hours:</p><br>
