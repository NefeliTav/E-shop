                                    ...
                                    <form method="post">
                                        ...
                                        <?php
                                            if (isset($_POST[$row[0]])) {
                                                ...
                                                $query = mysqli_query($conn,"SELECT * FROM cart WHERE idUsr={$_SESSION['id']} and id={$row[0]}");
                                                if (mysqli_num_rows($query)!=0)
                                                {
                                                    $query = mysqli_query($conn,"SELECT CAST(amount AS UNSIGNED) FROM cart WHERE idUsr={$_SESSION['id']} and id={$row[0]}");
                                                    ...
                                                    "UPDATE cart 
                                                    SET amount = $value 
                                                    WHERE idUsr={$_SESSION['id']} and id={$row[0]}");
                                                }
                                                else
                                                {
                                                    $result = mysqli_query($conn,"INSERT INTO cart (idUsr, id, amount) (SELECT u.id, p.id, '1' FROM users u, products p WHERE u.id={$_SESSION['id']} and p.id={$row[0]})     ");
                                                }
                                                unset($_POST[$row[0]]);
                                            }
                                        ?>
                                    ...
                                    <form method="post">
                                        ...
                                        <?php
                                            if (isset($_POST[$row[0]."2"])) {
                                                ...
                                                $query2 = mysqli_query($conn,"SELECT * FROM wishlist WHERE idUsr={$_SESSION['id']} and id={$row[0]}");
                                                if (mysqli_num_rows($query2)==0)
                                                {
                                                    $result2 = mysqli_query($conn,"INSERT INTO wishlist (idUsr, id) (SELECT u.id, p.id FROM users u, products p WHERE u.id={$_SESSION['id']} and p.id={$row[0]})     ");
                                                }
                                                unset($_POST[$row[0]]);
                                            }
                                        ?>
